...
S3_BASE="s3://konnect-central-logs/dev/Konnect-DEV-ElasticSearch/Monthly"
...
echo "🗓 Monthly Elasticsearch log upload"
...
if [ -z "$FILES" ]; then
  echo "⚠️ No rotated logs found in last 30 days. Exiting."
  exit 0
fi
