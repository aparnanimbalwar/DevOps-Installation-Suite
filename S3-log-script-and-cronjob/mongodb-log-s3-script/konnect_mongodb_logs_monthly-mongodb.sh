...
S3_BASE="s3://konnect-central-logs/dev/Konnect-DEV-MongoDB/Monthly"
...
echo "📅 Daily mongo log compression & upload"
...
############################################
if [ ! -f "$LOG_FILE" ]; then
  echo "❌ mongo log file not found: $LOG_FILE"
  exit 1
fi
...
echo "✅ mongo log uploaded successfully"
