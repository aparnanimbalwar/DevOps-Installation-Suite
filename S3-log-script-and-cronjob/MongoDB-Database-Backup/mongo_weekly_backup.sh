...
echo "==================================================" >> "$LOG_FILE"
echo "[$(date)] Starting MongoDB WEEKLY backup (${ENVIRONMENT})" >> "$LOG_FILE"
...
# --------- BACKUP ----------
BACKUP_NAME="mongodb_weekly_${ENVIRONMENT}_${DATE}_${TIME}"
...
echo "[$(date)] ✅ WEEKLY backup uploaded to ${S3_PATH}" >> "$LOG_FILE"
