...
echo "==================================================" >> "$LOG_FILE"
echo "[$(date)] Starting MongoDB MONTHLY backup (${ENVIRONMENT})" >> "$LOG_FILE"
...
# --------- BACKUP ----------
BACKUP_NAME="mongodb_monthly_${ENVIRONMENT}_${DATE}_${TIME}"
...
echo "[$(date)] ✅ MONTHLY backup uploaded to ${S3_PATH}" >> "$LOG_FILE"
